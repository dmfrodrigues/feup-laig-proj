                ...
                switch (parts[0]) {
                    ...
                    case 'usemtl':
                        ...
                        if(typeof material === 'undefined') console.error(`No such material ${materialId}`);
                            ...
                            if(groupId.slice(0, 2) === "default") object.material = this.mtllib.materials[materialId];
                            else                                  group .material = this.mtllib.materials[materialId];
                        }

                        if(typeof material.s !== 'undefined'){
                            s = material.s;
                        } else s = [1, 1, 1];
            ...
            if (parts.length > 0) {
                switch (parts[0]) {
                    ...
                    case 'map_Ks':
                        ...
                        let idx = 1;
                        if(parts[idx] === '-s'){
                            material.s = [parseFloat(parts[2]), parseFloat(parts[3]), parseFloat(parts[4])];
                            idx = 5;
                        }
