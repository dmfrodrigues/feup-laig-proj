                ...
                switch (parts[0]) {
                    ...
                    case 'f': {     // face element
                        function procVert(object, group, str) {
                            str = str.trim();
                            if (object.lut[str]) //already stored
                                // just add the index
                                group.indices.push(object.lut[str]);
                            else // not stored
                            {
                                ...
                                Array.prototype.push.apply(object.vertices , pos );
                                Array.prototype.push.apply(object.texCoords, tex );
                                Array.prototype.push.apply(object.normals  , norm);

                                // store index in lut

                                object.lut[str] = object.vcount;

                                group.indices.push(object.vcount);
