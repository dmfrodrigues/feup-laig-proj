                        ...
                        function procVert(object, group, str) {
                            ...
                            else // not stored
                            {
                                ...
                                Array.prototype.push.apply(
                                    object.vertices, positions[parseInt(f[0]) - 1]
                                );

                                if (f[1])
                                    Array.prototype.push.apply(
                                        object.texCoords, texCoords[parseInt(f[1]) - 1]
                                    );
                                if (f[2])
                                    Array.prototype.push.apply(
                                        object.normals, normals[parseInt(f[2]) - 1]
                                    );
                                ...
                                else               group.indices.push(object.vcount);
